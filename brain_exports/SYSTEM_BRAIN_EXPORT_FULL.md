...
│       │              │                               │
│  ┌────┴──────────────┴─────┐  ┌────────────────────┐│
│  │ Backend (NestJS) :3010  │  │ Frontend (Vite)    ││
│  │ JWT Auth                │  │ :3002 (dev)        ││
│  │ Socket.IO               │  │ :3002 (vite conf)  ││
...
- Axios instance, base URL from `VITE_API_BASE_URL` or `http://localhost:3010`
- Timeout: 10s
